...
<footer id="footer">
    <div class="container-fluid py-5 px-sm-5">
        <div class="row">
            ...
            <div class="col-6 col-xl-2 order-xl-3 px-sm-4 my-2">
            ...
            <div class="col-6 col-xl-3 order-xl-1 px-sm-4 my-2">
            ...
            <div class="col-6 col-xl-5 order-xl-4 text-right px-sm-4 my-2" id="footer-logo-section">
                <a
                    class="text-center"
