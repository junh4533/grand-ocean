...
<footer id="footer">
    <div class="container-fluid py-5 px-5">
        <div class="row">
            <div class="col-6 col-xl-3 order-xl-2 px-5">
            ...
            <div class="col-6 col-xl-3 order-xl-3 px-5">
            ...
            <div class="col-6 col-xl-3 order-xl-1 px-5">
            ...
            <div class="col-6 col-xl-3 order-xl-4 text-right px-5" id="footer-logo-section">
                <a
