...
<footer id="footer">
    <div class="container-fluid py-5 px-5">
        <div class="row">
            <div class="col-6 col-lg-3 order-lg-2 px-5">
            ...
            <div class="col-6 col-lg-3 order-lg-3 px-5">
            ...
            <div class="col-6 col-lg-3 order-lg-1 px-5">
            ...
            <div class="col-6 col-lg-3 order-lg-4 text-right px-5" id="footer-logo-section">
                <a
