jQuery(document).ready(function () {
    ...
    first_header.after('<h3 class="checkout-header">顾客信息</h3>');
    // first_header.addClass('checkout-header');
    let second_header = jQuery('.checkout-phone');
    second_header.after('<h3 class="checkout-header">地址</h3>');
    let third_header = jQuery('.woocommerce-additional-fields h3');
    third_header.after('<h3 class="checkout-header">细节</h3>');
