    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto d-flex align-items-center">
                <li class="nav-item">
                    <a class="nav-link text-nowrap" href="<?php echo get_site_url(); ?>">主页</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-nowrap" href="<?php echo get_site_url(); ?>#about-us">我们的故事</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-nowrap" href="<?php echo get_site_url(); ?>#products">今天的精选</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-nowrap" href="<?php echo get_site_url(); ?>#footer">联系我们</a>
                </li>
